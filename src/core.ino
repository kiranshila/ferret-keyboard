// ferret-lisp 0.4.0-1b48e90
        ...
        namespace ferret{
               ...
               #endif
         #ifndef FERRET_OBJECT_BOUNCE
               #define FERRET_OBJECT_BOUNCE
        ...
        namespace core{
                ...
                public:
                 ...
                 class new_lazy_seq final : public lambda_i{
                public:

                  var invoke (ref _args_) const  final  ;
                };

                 class list final : public lambda_i{
                public:

                  var invoke (ref _args_) const  final  ;
                };

                 class seqable_QMARK_ final : public lambda_i{
                public:
                ...
                public:
                 ...
                 class first final : public lambda_i{
                public:

                  var invoke (ref _args_) const  final  ;
                };

                 class rest final : public lambda_i{
                public:
                ...
                public:
                 ...
                 class map final : public lambda_i{
                public:
                ...
                public:
                 ...
                 class range final : public lambda_i{
                public:
                ...
                public:
                 ...
                 class ferret_matrix_row_count  {
                public:

                  var invoke (ref _args_) const  ;
                };

                 class ferret_matrix_column_count  {
                public:

                  var invoke (ref _args_) const  ;
                };

                 class ferret_matrix_zeros  {
                public:

                  var invoke (ref _args_) const  ;
                };

                 class ferret_matrix_mset_BANG_  {
                public:

                  var invoke (ref _args_) const  ;
                };

                 class ferret_matrix_mget  {
                public:

                  var invoke (ref _args_) const  ;
                };

                 class ferret_arduino_digital_write  {
                public:

                  var invoke (ref _args_) const  ;
                };

                 class ferret_arduino_digital_read  {
                public:
        ...
        namespace core{
                ...
                inline var new_lazy_seq::invoke (ref _args_) const {
                  (void)(_args_);
                ...
                inline var list::invoke (ref _args_) const {
                  (void)(_args_);
                  ref xs = _args_;
                ...
                inline var seqable_QMARK_::invoke (ref _args_) const {
                  (void)(_args_);
                  ref coll = rt::first(_args_);
                ...
                inline var cons::invoke (ref _args_) const {
                  (void)(_args_);
                  ref x = rt::first(_args_);
                  ref seq = rt::first(rt::rest(_args_));

                  return rt::cons(x, seq);;
                }
               

                inline var first::invoke (ref _args_) const {
                  (void)(_args_);
                  ref x = rt::first(_args_);
                ...
                inline var rest::invoke (ref _args_) const {
                  (void)(_args_);
                  ref x = rt::first(_args_);
                ...
                inline var apply::invoke (ref _args_) const {
                  (void)(_args_);
                  ref f = rt::first(_args_);
                  ref argv = rt::rest(_args_);
                ...
                inline var _doseq_::invoke (ref _args_) const {
                  (void)(_args_);
                  ref seq = rt::first(_args_);
                  ref f = rt::first(rt::rest(_args_));

                  for_each(it, seq) run(f,it);;
                  return nil();
                }
                ...
                inline var map::invoke (ref _args_) const {
                  (void)(_args_);
                ...
                inline var range::invoke (ref _args_) const {
                  (void)(_args_);
                ...
                inline var every_QMARK_::invoke (ref _args_) const {
                  (void)(_args_);
                  ref pred = rt::first(_args_);
                  ref coll = rt::first(rt::rest(_args_));
                ...
                inline var ferret_matrix_row_count::invoke (ref _args_) const {
                  (void)(_args_);
                  matrix &u = value<matrix>::to_reference(rt::first(_args_));

                  return obj<number>(matrix::row_count(u));;
                }
               

                inline var ferret_matrix_column_count::invoke (ref _args_) const {
                  (void)(_args_);
                  matrix &u = value<matrix>::to_reference(rt::first(_args_));
                ...
                inline var ferret_matrix_zeros::invoke (ref _args_) const {
                  (void)(_args_);
                  size_t r = number::to<size_t>(rt::first(_args_));
                  size_t c = number::to<size_t>(rt::first(rt::rest(_args_)));

                  return obj<matrix_t>(matrix::zeros(r, c));;
                }
               

                inline var ferret_matrix_mset_BANG_::invoke (ref _args_) const {
                  (void)(_args_);
                  matrix &u = value<matrix>::to_reference(rt::first(_args_));
                  size_t r = number::to<size_t>(rt::first(rt::rest(_args_)));
                  size_t c = number::to<size_t>(rt::first(rt::rest(rt::rest(_args_))));
                  real_t v = number::to<real_t>(rt::first(rt::rest(rt::rest(rt::rest(_args_)))));
                ...
                inline var ferret_matrix_mget::invoke (ref _args_) const {
                  (void)(_args_);
                  matrix &u = value<matrix>::to_reference(rt::first(_args_));
                  size_t r = number::to<size_t>(rt::first(rt::rest(_args_)));
                  size_t c = number::to<size_t>(rt::first(rt::rest(rt::rest(_args_))));
                ...
                inline var ferret_arduino_digital_write::invoke (ref _args_) const {
                  (void)(_args_);
                  number_t pin = number::to<number_t>(rt::first(_args_));
                  number_t val = number::to<number_t>(rt::first(rt::rest(_args_)));


                  #if defined FERRET_HARDWARE_ARDUINO 
                  #define FERRET_ARDUINO_DIGITAL_WRITE_ENABLED
                  ::digitalWrite(pin, val);
                  #endif

                  #if !defined FERRET_ARDUINO_DIGITAL_WRITE_ENABLED 
                  # error ferret_arduino_digital_write Not Supported on This Platform 
                  #endif
                  ;
                  return nil();
                }
                ...
                inline var ferret_arduino_digital_read::invoke (ref _args_) const {
                  (void)(_args_);
                  number_t pin = number::to<number_t>(rt::first(_args_));


                  #if defined FERRET_HARDWARE_ARDUINO 
                  #define FERRET_ARDUINO_DIGITAL_READ_ENABLED
                  return obj<number>(::digitalRead(pin));
                  #endif

                  #if !defined FERRET_ARDUINO_DIGITAL_READ_ENABLED 
                  # error ferret_arduino_digital_read Not Supported on This Platform 
                  #endif
                  ;
                }
                ...
                inline var arduino_write_byte::invoke (ref _args_) const {
                  (void)(_args_);
                  byte b = number::to<byte>(rt::first(_args_));
